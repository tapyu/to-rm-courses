...
From these definitions, we can infer a nonobvious equality that is rather useful when we handle matrix differentiations. If we consider a special case of the gradient matrix (Eq.\eqref{eq:gradient-matrix-num}) when $m=1 \therefore \mathbf{X} = \mathbf{x}^\mathsf{T} \in \mathbb{R}^{1\times n}$, where $\mathbf{x} \in \mathbb{R}^n$, we have that
\begin{align}
    \left[\dfrac{\partial \alpha}{\partial \mathbf{x}^\mathsf{T}}\right]_{\textnormal{Num}} = \begin{bmatrix} \dfrac{\partial \alpha}{\partial x_{1}} & \dfrac{\partial \alpha}{\partial x_{2}} & \cdots & \dfrac{\partial \alpha}{\partial x_{n}} \end{bmatrix} \in \mathbb{R}^{n}.
\end{align}
...
\begin{align}
    \label{eq:hidden-num}
    \left[\dfrac{\partial \alpha}{\partial \mathbf{x}^\mathsf{T}}\right]_{\textnormal{Num}} = \left[\dfrac{\partial \alpha}{\partial \mathbf{x}}\right]_{\textnormal{Num}}
\end{align}
...
\begin{align}
    \label{eq:hessian-eq}
    \mathbf{H} = \dfrac{\partial^{2} f(\mathbf{x})}{\partial \mathbf{x} \partial \mathbf{x}^\mathsf{T}} = \renewcommand{\arraystretch}{2.2}\begin{bmatrix}
    ...
    \end{bmatrix}
\end{align}
where \(f: \mathbb{R}^{n} \rightarrow \mathbb{R}\) and \(\mathbf{x} \in \mathbb{R}^{n}\). We can rewrite it recalling the Eq.\eqref{eq:hidden-num}, that is,
\begin{align}
    \mathbf{H} = \dfrac{\partial^{2} f(\mathbf{x})}{\partial \mathbf{x} \partial \mathbf{x}^\mathsf{T}} = \dfrac{\partial }{\partial \mathbf{x}}\left( \dfrac{\partial f(\mathbf{x})}{\partial \mathbf{x}^\mathsf{T}} \right) = \dfrac{\partial }{\partial \mathbf{x}}\left( \dfrac{\partial f(\mathbf{x})}{\partial \mathbf{x}} \right),
\end{align}
we have found a restriction here: we have not defined a matrix-vector differentiation for the numerator layout. Since \(\frac{\partial f(\mathbf{x})}{\partial \mathbf{x}}\) is a \(1\times n\) matrix (or a row vector), we cannot going on. Therefore, the matrix calculus of the Hessian notation in Eq.\eqref{eq:hessian-eq} does not follow the numerator layout.
...
\begin{align}
    \left[\dfrac{\partial \alpha}{\partial \mathbf{x}^\mathsf{T}}\right]_{\textnormal{Den}} = \begin{bmatrix} \dfrac{\partial \alpha}{\partial x_{1}} \\
...
\begin{align}
    \label{eq:hidden-den}
    \left[\dfrac{\partial \alpha}{\partial \mathbf{x}^\mathsf{T}}\right]_{\textnormal{Den}} = \left[\dfrac{\partial \alpha}{\partial \mathbf{x}}\right]_{\textnormal{Den}}
\end{align}
...
\begin{align}
    \left[ \mathbf{J} \right]_{\textnormal{Den}} & = \frac{\partial f(\mathbf{x})}{\partial \mathbf{x}}^{\mathsf{T}} \\
    & = \frac{\partial f(\mathbf{x})}{\partial \mathbf{x}}^\mathsf{T}\\
    & = \begin{bmatrix}
    ...
    & = \renewcommand{\arraystretch}{2.2}\begin{bmatrix}
        \dfrac{\partial f_1(\mathbf{x})}{\partial \mathbf{x}}^\mathsf{T} \\ \dfrac{\partial f_2(\mathbf{x})}{\partial \mathbf{x}}^\mathsf{T} \\ \vdots \\ \dfrac{\partial f_m(\mathbf{x})}{\partial \mathbf{x}}^\mathsf{T}
    \end{bmatrix}
\end{align}
...
\begin{align}
    \mathbf{H} = \dfrac{\partial^{2} f(\mathbf{x})}{\partial \mathbf{x} \partial \mathbf{x}^\mathsf{T}} = \dfrac{\partial }{\partial \mathbf{x}}\left( \dfrac{\partial f(\mathbf{x})}{\partial \mathbf{x}^\mathsf{T}} \right),
\end{align}
...
\begin{align}
    \mathbf{H} = \left[ \dfrac{\partial^{2} f(\mathbf{x})}{\partial \mathbf{x} \partial \mathbf{x}^\mathsf{T}} \right]_{\textnormal{Den}}
\end{align}
...
\begin{itemize}
    ...
    \item \(\mathbf{J} = \dfrac{\partial f(\mathbf{x})}{\partial \mathbf{x}}^\mathsf{T}\).
    \item \(\mathbf{H} = \dfrac{\partial^{2} f(\mathbf{x})}{\partial \mathbf{x} \partial \mathbf{x}^\mathsf{T}}\).
    \item \(\dfrac{\partial\alpha}{\partial \mathbf{x}^\mathsf{T}} = \dfrac{\partial\alpha}{\partial \mathbf{x}}\).
\end{itemize}
