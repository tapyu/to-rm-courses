...
\begin{align}
    \left[\dfrac{\partial \mathbf{Y}}{\partial x}\right]_{\textnormal{Dem}} \renewcommand{\arraystretch}{1.8} = \begin{bmatrix}
...
Let \(\mathbf{x} \in \mathbb{C}^{n}\), \(\mathbf{z} \in \mathbb{C}^{m}\) and \(\mathbf{A} \in \mathbb{C}^{m\times n}\), where \(\mathbf{x}\) depends on \(\mathbf{z}\), but \(\mathbf{A}\) does not. Then
\begin{align}
    ...
    \end{bmatrix} \renewcommand{\arraystretch}{2.6}\begin{bmatrix}
        \dfrac{\partial x_1}{\partial \mathbf{z}}^{\trans} \\
        \dfrac{\partial x_2}{\partial \mathbf{z}}^{\trans} \\
        \vdots \\
        \dfrac{\partial x_n}{\partial \mathbf{z}}^{\trans}
    \end{bmatrix} \\
    & = \begin{bmatrix}
        a_{11} & a_{21} & \dots & a_{m1} \\
        a_{12} & a_{22} & \dots & a_{m2} \\
        ...
        a_{1n} & a_{2n} & \dots & a_{mn} \\
    \end{bmatrix} \begin{bmatrix}
        \dfrac{\partial x_1}{\partial \mathbf{z}}
        \dfrac{\partial x_2}{\partial \mathbf{z}}
        \cdots
        \dfrac{\partial x_n}{\partial \mathbf{z}}
    \end{bmatrix}^\trans
\end{align}
\begin{align}
    \boxed{\dfrac{\partial \mathbf{A}  \mathbf{x}}{\partial \mathbf{z}} = \mathbf{A}^\trans\dfrac{\partial \mathbf{x}}{\partial \mathbf{z}}^\trans }
\end{align}
...
\begin{align}
    ...
    % & = \begin{bmatrix}
    %     \dfrac{\partial}{\partial z_1} \sum_{i=1}^{n} y_ix_i \\
    %     \dfrac{\partial}{\partial z_2} \sum_{i=1}^{n} y_ix_i \\
    %     \vdots \\
    %     \dfrac{\partial}{\partial z_2} \sum_{i=1}^{n} y_ix_i \\
    % \end{bmatrix}
\end{align}
...
\end{align}
\begin{align}
    \boxed{\dfrac{\partial \mathbf{x}^\trans \mathbf{y}}{\partial \mathbf{z}} = \dfrac{\partial \mathbf{x}}{\partial \mathbf{z}}\mathbf{y} + \dfrac{\partial \mathbf{y}}{\partial \mathbf{z}}\mathbf{x}}
\end{align}
