...
\begin{xltabular}{\textwidth}{XX}
    ...
    \(\nullspace{\mathbf{A}}\) & Nullspace (or kernel), i.e., \(\dim{\range{\mathbf{A}}}\)\\
...
\begin{xltabular}{\textwidth}{XX}
    ...
    \(\mathcal{S}^{n}, \mathbb{S}^{n}\) & Conic set of the symmetric \(n\times n\)-dimensional matrices\\
    \(\mathcal{S}_{+}^{n}, \mathbb{S}_{+}^{n}\) & Conic set of the symmetric positive semidefinite \(n\times n\)-dimensional matrices\\
    \(\mathcal{S}_{++}^{n}, \mathbb{S}_{++}^{n}\) & Conic set of the symmetric positive definite \(n\times n\)-dimensional matrices, i.e., \(\mathcal{S}_{++}^{n} = \mathcal{S}_{+}^{n}\setminus \left\{ \mathbf{0} \right\}\)\\
