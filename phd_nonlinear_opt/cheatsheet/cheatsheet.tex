...
\begin{itemize}
    ...
    \item It is guaranteed that \(\exists!\; \mathbf{x}^{\star} \in \mathbb{R}^{n} \mid f(\mathbf{x}^{\star}) \leq f(\mathbf{y})\;\forall\;\mathbf{y}\in\dom{f} \wedge \nabla f(\mathbf{x}^{\star}) = \mathbf{0} \). This \(\mathbf{x}^{\star}\) is the global minimum.
...
\begin{itemize}
    ...
    \item It is guaranteed that \(\exists!\; \mathbf{x}^{\star} \in \mathbb{R}^{n} \mid f(\mathbf{x}^{\star}) \leq f(\mathbf{y})\;\forall\;\mathbf{y}\in\dom{f} \wedge \nabla f(\mathbf{x}^{\star}) = \mathbf{0} \). This \(\mathbf{x}^{\star}\) is the global maximum. 
