...
\end{tabularx}
    \begin{tabularx}{\textwidth}{|>{\setlength\hsize{1\hsize}\setlength\linewidth{\hsize}}X|>{\setlength\hsize{.9\hsize}\setlength\linewidth{\hsize}}X|>{\setlength\hsize{1.1\hsize}\setlength\linewidth{\hsize}}X|}%{| >{\hsize=.5\hsize}X | >{\hsize=1.5\hsize}X |}
        ...
        Pointwise infimum:
        \begin{itemize}[leftmargin=*]
            \item \(f(x) = \underset{y \in \mathcal{A}}{\textnormal{inf }} g(x,y)\).
        \end{itemize} & \vspace{-3.5ex} \begin{itemize}[leftmargin=*]
            \item .%\(f\) is convex in \(x\) if \(g\) is convex in \(x\) for each \(y \in \mathcal{A}\).
            % \item \(f\) is concave in \(x\) if \(g\) is concave in \(x\) for each \(y \in \mathcal{A}\).
        \end{itemize} &
        \vspace{-3.5ex} \begin{itemize}[leftmargin=*]
        ...
        Pointwise supremum:
        \begin{itemize}[leftmargin=*]
            \item \(f(x) = \underset{y \in \mathcal{A}}{\textnormal{sup }} g(x,y)\).
        \end{itemize} & \vspace{-3.5ex} \begin{itemize}[leftmargin=*]
            \item \(f\) is convex in \(x\) if \(g\) is convex in \(x\) for each \(y \in \mathcal{A}\).
            \item \(f\) is concave in \(x\) if \(g\) is concave in \(x\) for each \(y \in \mathcal{A}\).
        \end{itemize} &
