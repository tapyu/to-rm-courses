...
\begin{tikzpicture}[
    ...
    metaheuristic/.style={rectangle, draw=green!60, fill=green!5, very thick, minimum size=5mm},
    ml/.style={rectangle, draw=brown!60, fill=brown!5, very thick, minimum size=5mm},
    adapfilt/.style={rectangle, draw=orange!60, fill=orange!5, very thick, minimum size=5mm},
    ...
    \node[adapfilt, align=center]      (stochasticgradient)   [below of=wiener, left of=wiener] {Stochastic gradient\\Algorithms};
    \node[adapfilt, align=center]      (lms)   [below of=stochasticgradient, left of=stochasticgradient] {Least-Mean Square\\(LMS) Algorithm};
    \node[adapfilt, align=center]      (nlms)   [below of=lms, left of=lms] {Normalized Least-Mean\\Square (NLMS) Algorithm};
    \node[adapfilt, align=center]      (rls)   [below of=wiener, right of=wiener] {Recursive Least\\Square (RLS) Algorithm};
    ...
    (wiener) edge node [] {} (stochasticgradient)
    (wiener) edge node [] {} (rls)
